                ...
                <div class="card border-info rounded-0">
                    <div class="card-header p-0">
                        <div class="bg-info text-white text-center py-2">
                            <h3><i class="fa fa-user"></i> Registration Form</h3>
                        </div>
                    </div>
                    <div class="card-body p-3">                
                        ...
                        <div class="form-group">
                            <div class="input-group mb-2">
                                ...
                                <input type="password" class="form-control" id="password-confirm" name="confirm_password" placeholder="Confirm Password *">
                            </div>
                        </div>  
                        <div class="text-center">
                            <button type="submit" id="contact-send-a" class="btn btn-info btn-block rounded-0 py-2">Register</button>
                            <a href="<?php echo base_url()?>index.php/Auth/login" class="btn btn-info btn-block rounded-0 py-2">Sign In</a>
                        </div>
                    </div>
                </div> 
              </div>
